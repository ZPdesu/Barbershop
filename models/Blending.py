...
class Blending(nn.Module):
    ...
    def blend_images(self, img_path1, img_path2, img_path3, sign="realistic"):
        ...
        return self.save_blend_results(
            im_name_1, im_name_2, im_name_3, sign, I_G, latent_mixed, latent_F_mixed
        )

    def save_blend_results(
        self, im_name_1, im_name_2, im_name_3, sign, gen_im, latent_in, latent_F
    ):
        ...
        latent_path = os.path.join(
            save_dir, "{}_{}_{}.npz".format(im_name_1, im_name_2, im_name_3)
        )
        image_path = os.path.join(
            save_dir, "{}_{}_{}.png".format(im_name_1, im_name_2, im_name_3)
        )
